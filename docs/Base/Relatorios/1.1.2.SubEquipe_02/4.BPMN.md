...
| -- | -- | -- |
| Davi Severiano Freitas | Análise do fluxo encontrado com a engenharia reversa, elaboração conjunta dos diagramas BPMN e revisão estrutural das regras de negócio. | *Ver histórico de commits* |
| Daniel de Oliveira Lira | Análise do fluxo encontrado com a engenharia reversa, elaboração conjunta dos diagramas BPMN e revisão metodológica da rastreabilidade. | *Ver histórico de commits* |
| Mateus Rodrigues Barreto | Análise do fluxo, elaboração conjunta dos diagramas BPMN (foco em Recuperação de Falhas) e estruturação do documento. | *Ver histórico de commits* |
| Pedro Henrique Freire Rodrigues | Análise do fluxo, elaboração conjunta dos diagramas BPMN (foco em Chat e Bits) e especificação textual do artefato. | *Ver histórico de commits* |
