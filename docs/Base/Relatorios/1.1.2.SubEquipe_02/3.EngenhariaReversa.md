...
> 🖼️ **Imagem pendente.** Salvar o arquivo em `docs/assets/engenharia-reversa/subequipe_02_evidencia-01.png` (ver [Padrão de Assets](../../../assets/README.md)) e substituir este bloco por:
>
> ```markdown
