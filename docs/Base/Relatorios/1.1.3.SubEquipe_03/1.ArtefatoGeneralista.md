...
> 🖼️ **Imagem pendente.** Salvar o arquivo em `docs/assets/artefatos/subequipe_03_artefato-generalista.png` (ver [Padrão de Assets](../../../assets/README.md)) e substituir este bloco por:
>
> ```markdown
> ![Artefato Generalista — SubEquipe_03](../../../assets/artefatos/subequipe_03_artefato-generalista.png)
> ```
