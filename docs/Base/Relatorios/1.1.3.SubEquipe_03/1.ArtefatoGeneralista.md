...
| :--: | :--: | -- | -- | -- | -- |
| 1.0 | 21/08/2026 | Criação da estrutura base da página | Lucas Andrade Zanetti | Heitor Macedo Ricardo | Revisão da estrutura base da página. |
| 1.1 | 26/08/2026 | Inclusão do Rich Picture v1.0 (`subequipe_03_artefato-generalista.png`), detalhamento da metodologia colaborativa, fundamentação teórica (SSM), leitura completa dos 7 núcleos, matriz de rastreabilidade, senso crítico e registro de participações ativas da SubEquipe_03 | Eduardo Lôbo Moreira, Hugo Freitas Silva, Philipe Amâncio Reis Caetano | Equipe G6 | Conferência do Rich Picture v1.0 (7 núcleos), fundamentação em SSM, balões de preocupação e rastreabilidade. |
| 1.2 | 27/08/2026 | Correção das rotas e links internos para o padrão Docsify | Eduardo Lôbo Moreira, Hugo Freitas Silva, Philipe Amâncio Reis Caetano | Equipe G6 | Validação da resolução dos links e rotas internas no Docsify. |
