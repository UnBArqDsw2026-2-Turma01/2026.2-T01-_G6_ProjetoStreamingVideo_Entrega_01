...
| -- | -- | -- | -- |
| **Mapeamento de Atores e Atividades (Seções 6.1 e 6.2)** | Modelo BPMN do Fluxo |  [4.BPMN.md](4.BPMN.md) | Os atores e o sequenciamento de requisições mapeados convertem-se diretamente nas *Pools*, *Lanes* e tarefas (*tasks*) do diagrama visual do processo. |
...
| 1.1 | 27/08/2026 | Adição do fluxo mapeado, modelagem de BD, tabelas de domínio e evidências visuais (SubEquipe 3) | Eduardo L., Hugo F., Philipe A. | _(A preencher)_ | Conferência das evidências de tráfego, contratos de rotas abertas (GraphQL, Usher CDN, WebSockets) e ABR. |