...
| -- | -- | -- | -- |
| **Artefato Generalista (Rich Picture)** | Domínio de streaming ao vivo, UGC e plataformas de referência (Twitch/YouTube/Kick) | [SIG (NFR)](2.NFRFramework.md), [BPMN](4.BPMN.md) e [Escopo do Produto](../../../Projeto/EscopoProduto.md) | Fornece os atores, dores/preocupações e fluxos sociotécnicos que originam os softgoals e os processos modelados. |
| **SIG (NFR Framework)** | Rich Picture e pesquisa de arquiteturas resilientes | [Engenharia Reversa](3.EngenhariaReversa.md) e [BPMN](4.BPMN.md) | Decompõe os atributos de qualidade e trade-offs a serem verificados no sistema real. |
| **Modelo BPMN** | Atores do Rich Picture e fluxo de chat/moderação sob concorrência | [Engenharia Reversa](3.EngenhariaReversa.md) | Detalha a sequência temporal e pools/lanes de interação síncrona. |
