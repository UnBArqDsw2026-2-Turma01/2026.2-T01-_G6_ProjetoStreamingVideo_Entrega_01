...
| 1.1 | 23/08/2026 | Definição do fluxo modelado (Assistir Transmissão ao Vivo) e da ferramenta (Camunda), a partir da Ata S1_01 | [SubEquipe_01](../../../Projeto/Atas/Atas_Sg1/ata-S1-01-2026-08-23.md) | Lucas Andrade Zanetti |
| 1.2 | 27/08/2026 | Publicação do modelo v1: sete diagramas encadeados (D0 a D5), fundamentação da notação, inventário de 43 tipos de elemento com justificativa, leitura do modelo, rastreabilidade elemento a elemento e senso crítico | Lucas Andrade Zanetti | Heitor Macedo Ricardo, Matheus Lemes Amaral, Pedro Druck Montalvão Reis |
