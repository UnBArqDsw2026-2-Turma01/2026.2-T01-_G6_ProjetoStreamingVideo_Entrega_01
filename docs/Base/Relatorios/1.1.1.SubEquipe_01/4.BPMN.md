...
> **Entregue**: **sete** diagramas encadeados no Bloco A, sendo um o fluxo mínimo, um o modelo integrador e cinco os processos chamados por eles.
> **Status**: página dividida em **4 blocos**, um por NFR — ver [§0](#_0-divisão-do-foco-em-blocos) e o detalhe completo em [Engenharia Reversa §0](3.EngenhariaReversa.md#_0-divisão-do-foco-entre-os-4-membros). **Bloco A (Performance/Latência)**: v1 concluída (27/08/2026), pendente revisão da subequipe. **Blocos B, C e D**: pendentes.

## 0. Divisão do Foco em Blocos

Mesma divisão da página de [Engenharia Reversa §0](3.EngenhariaReversa.md#_0-divisão-do-foco-entre-os-4-membros) — cada bloco de Eng. Reversa tem o BPMN correspondente aqui, com prefixo de diagrama próprio para não colidir IDs entre membros. **Mantenha esta tabela sincronizada com a de Eng. Reversa §0 ao atualizar uma das duas.**

| Bloco | NFR / Softgoal | Responsável | Diagramas (prefixo) | Status |
| -- | -- | -- | -- | -- |
| **A** | Performance / Baixa Latência | Lucas Andrade Zanetti | `D0`–`D5`, `D2b` | ✅ v1 concluída |
| **B** | Usabilidade / Interatividade | _(a definir)_ | `U0`… | ⬜ pendente |
| **C** | Confiabilidade / Disponibilidade | _(a definir)_ | `C0`… | ⬜ pendente |
| **D** | Segurança | _(a definir)_ | `S0`… | ⬜ pendente |

> §1 (Metodologia) e §2 (Fundamentação Teórica — BPMN) abaixo são **compartilhados pelos 4 blocos**: a notação, a ferramenta e a regra de origem ("nenhum elemento sem achado que o sustente") não mudam com o NFR modelado. Convenção de nomes de arquivo e como gerar/validar um diagrama novo: [`tools/README.md`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/README.md#bpmn--geração-e-renderização-dos-diagramas).
...
| Como os arquivos foram produzidos | A especificação de cada diagrama é código versionado em [`tools/bpmn/diagramas/`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/bpmn/diagramas/); [`gerador.py`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/bpmn/gerador.py) emite o BPMN 2.0 com geometria, e [`renderizar.sh`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/bpmn/renderizar.sh) gera os PNG com a própria biblioteca do bpmn.io. Motivo em [§7](#_7-senso-crítico) |
...
| Uso de IA generativa (Bloco A) | Sim — mesma sessão da engenharia reversa. Detalhamento em [FOCO_03](5.IAGenerativa.md#_2-onde-a-ia-generativa-foi-utilizada). Cada bloco registra o uso próprio quando fizer o trabalho |
...
> As seções 3 a 9 abaixo são o conteúdo deste bloco — v1 concluída em 27/08/2026, pendente revisão de um segundo membro (§8). Índice completo dos 4 blocos em [§0](#_0-divisão-do-foco-em-blocos).
...
| Arquivos-fonte editáveis | [`docs/assets/bpmn/`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/tree/main/docs/assets/bpmn) — sete arquivos `.bpmn` |
...
*Figura 2 — D0: percurso de um quadro de vídeo da câmera até a tela, com o orçamento de latência anotado etapa a etapa. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d0-cadeia-latencia.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d0-cadeia-latencia.bpmn).*
...
*Figura 3 — D2: da abertura da página do canal ao encerramento da sessão de reprodução. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d2-assistir-transmissao.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d2-assistir-transmissao.bpmn).*
...
*Figura 4 — D2b: expansão do subprocesso de estado estacionário de D2, onde a latência é gasta e recuperada. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d2b-ciclo-reproducao.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d2b-ciclo-reproducao.bpmn).*
...
*Figura 5 — D1: ingestão, transcodificação e empacotamento — a metade da cadeia anterior ao espectador. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d1-iniciar-transmissao.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d1-iniciar-transmissao.bpmn).*
...
*Figura 6 — D3: entradas observáveis da decisão de troca de faixa e efeito observável dela. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d3-adaptacao-qualidade.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d3-adaptacao-qualidade.bpmn).*
...
*Figura 7 — D4: tratamento dos três modos de falha evidenciados do lado do cliente. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d4-recuperacao.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d4-recuperacao.bpmn).*
...
*Figura 8 — D5: conexão persistente multiplexada por tópicos, no padrão publicar/assinar. Autor: Lucas Andrade Zanetti, 27/08/2026. Fonte: [`subequipe_01_bpmn-d5-tempo-real.bpmn`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/bpmn/subequipe_01_bpmn-d5-tempo-real.bpmn).*

## 4. Elementos da Notação Utilizados

O conjunto abaixo é o inventário real dos sete arquivos: **43 tipos distintos** de elemento, **481 elementos** no total. A coluna da direita é o que importa — nenhum recurso entrou por enfeite; cada um resolve um problema que a alternativa mais simples não resolveria.
...
| Elemento | Qtd. | Onde e por quê |
| -- | :--: | -- |
| Tarefa de serviço | 38 | Passos automáticos executados por software |
...
| Tarefa de envio / recebimento | 9+4 | Extremidades de fluxo de mensagem entre *pools* |
...
| **Anotação de texto** | 39 | Onde a medição entra no diagrama. Cada anotação traz o número, a unidade, a evidência que o sustenta e, quando é o caso, a palavra **NÃO MEDIDO** |
| Associação | 39 | Ligação das anotações aos elementos anotados |
| Fluxo de mensagem | 22 | Toda comunicação entre *pools* |
| Fluxo de sequência | 167 | Ordenação dentro de cada processo |
...
| Raia *Serviço de autorização* + tarefa de regra | A03, A04, RN01, RN02 | Eng. Reversa §6.2/6.3 | [EV-01](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev01-token.json) |
...
| Raia *Balanceador* + "selecionar cluster e nó" | A05, RN05 | Eng. Reversa §6.2 | [EV-02](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev02-manifesto-mestre.m3u8) |
| *Pool* separado do serviço de manifesto (D2b) | **RN04** — não cacheável, montado por sessão | Eng. Reversa §6.3 | [EV-03](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev03-manifesto-de-midia.m3u8) |
| Armazenamento *Cache do PoP de borda* + gateway de acerto | RN04, H04 | Eng. Reversa §3.1/6.3 | [EV-04](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev04-tempos.txt) |
| Gateway baseado em evento do ciclo | RN07 (1 segmento novo por volta de 2 s) | Eng. Reversa §6.3 | [EV-05](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev05-medicoes-de-latencia.txt) |
...
| Multi-instância "assinar os tópicos" (D5) | RN11 (36 tópicos numa conexão) | Eng. Reversa §6.3 | [EV-06](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/docs/assets/engenharia-reversa/subequipe_01/performance-latencia/ev06-tempo-real.txt) |
...
**O que falta para a v2**: revisão por segundo membro; segunda coleta para dar peso estatístico às anotações; ajuste fino de layout no Camunda Modeler; e a medição que ficou faltando — cronometrar chat e vídeo lado a lado para transformar RN12 de inferência em medida.

## 8. Participantes & Comprobatórios

| Membro | Contribuição | Comprobatório (commit/PR) |
| -- | -- | -- |
| Lucas Andrade Zanetti | Arquitetura do conjunto de sete diagramas; especificação de D0 a D5; ferramentas de geração e renderização; redação desta página | _(preencher com o link do commit/PR)_ |
| Heitor Macedo Ricardo | _(preencher — revisão da aderência à notação)_ | |
...
> **Status**: ⬜ pendente. Segue a mesma notação e a mesma regra de origem do [Bloco A](#bloco-a-performance-baixa-latência-lucas-andrade-zanetti) (§1-§2 no topo desta página, compartilhados pelos 4 blocos) — o que falta é o modelo em si, construído sobre os achados do [Bloco B de Engenharia Reversa](3.EngenhariaReversa.md#bloco-b-usabilidade-interatividade-responsável-a-definir).

### B.1. Modelo BPMN

| Item | Valor |
| -- | -- |
| Fluxo(s) modelado(s) | _a definir — ver sugestões em [Eng. Reversa, Bloco B §B.1](3.EngenhariaReversa.md#b1-contexto-da-aplicação-analisada)_ |
| Ferramenta | Camunda Modeler / bpmn.io — à mão, ou por código como o Bloco A (ver [`tools/README.md`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/README.md#bpmn--geração-e-renderização-dos-diagramas)) |
| Prefixo dos diagramas | `U` (`U0`, `U1`…) — não reutilizar `D` (já é do Bloco A) |
| Arquivo(s)-fonte | `docs/assets/bpmn/subequipe_01_bpmn-u0-*.bpmn` (convenção completa em `tools/README.md`) |
| Versão do modelo | _a definir_ |

### B.2. Elementos da Notação Utilizados

_a preencher — quais recursos do BPMN (eventos, gateways, raias, dados) este bloco usa e por quê, no mesmo espírito do [Bloco A §4](#_4-elementos-da-notação-utilizados)._

### B.3. Leitura do Modelo

_a preencher — narrativa do evento de início ao fim, gateway a gateway._

### B.4. Rastreabilidade & Elos com Outros Artefatos

_a preencher — todo elemento com origem em [Eng. Reversa, Bloco B](3.EngenhariaReversa.md#b5-achados)._

### B.5. Senso Crítico

_a preencher._

### B.6. Participantes & Comprobatórios
...
_a preencher — consolidar em [6.Referencias.md](6.Referencias.md)._

## Bloco C — Confiabilidade / Disponibilidade (responsável a definir)

> **Status**: ⬜ pendente. Segue a mesma notação e a mesma regra de origem do [Bloco A](#bloco-a-performance-baixa-latência-lucas-andrade-zanetti) (§1-§2 no topo desta página, compartilhados pelos 4 blocos) — o que falta é o modelo em si, construído sobre os achados do [Bloco C de Engenharia Reversa](3.EngenhariaReversa.md#bloco-c-confiabilidade-disponibilidade-responsável-a-definir).

### C.1. Modelo BPMN

| Item | Valor |
| -- | -- |
| Fluxo(s) modelado(s) | _a definir — ver sugestões em [Eng. Reversa, Bloco C §C.1](3.EngenhariaReversa.md#c1-contexto-da-aplicação-analisada)_ |
| Ferramenta | Camunda Modeler / bpmn.io — à mão, ou por código como o Bloco A (ver [`tools/README.md`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/README.md#bpmn--geração-e-renderização-dos-diagramas)) |
| Prefixo dos diagramas | `C` (`C0`, `C1`…) — não reutilizar `D` (já é do Bloco A) |
| Arquivo(s)-fonte | `docs/assets/bpmn/subequipe_01_bpmn-c0-*.bpmn` (convenção completa em `tools/README.md`) |
| Versão do modelo | _a definir_ |

### C.2. Elementos da Notação Utilizados

_a preencher — quais recursos do BPMN (eventos, gateways, raias, dados) este bloco usa e por quê, no mesmo espírito do [Bloco A §4](#_4-elementos-da-notação-utilizados)._

### C.3. Leitura do Modelo

_a preencher — narrativa do evento de início ao fim, gateway a gateway._

### C.4. Rastreabilidade & Elos com Outros Artefatos

_a preencher — todo elemento com origem em [Eng. Reversa, Bloco C](3.EngenhariaReversa.md#c5-achados)._

### C.5. Senso Crítico

_a preencher._

### C.6. Participantes & Comprobatórios
...
> **Status**: ⬜ pendente. Segue a mesma notação e a mesma regra de origem do [Bloco A](#bloco-a-performance-baixa-latência-lucas-andrade-zanetti) (§1-§2 no topo desta página, compartilhados pelos 4 blocos) — o que falta é o modelo em si, construído sobre os achados do [Bloco D de Engenharia Reversa](3.EngenhariaReversa.md#bloco-d--seguranca-responsável-a-definir).

### D.1. Modelo BPMN

| Item | Valor |
| -- | -- |
| Fluxo(s) modelado(s) | _a definir — ver sugestões em [Eng. Reversa, Bloco D §D.1](3.EngenhariaReversa.md#d1-contexto-da-aplicação-analisada)_ |
| Ferramenta | Camunda Modeler / bpmn.io — à mão, ou por código como o Bloco A (ver [`tools/README.md`](https://github.com/UnBArqDsw2026-2-Turma01/G7_LiveVideoStreaming/blob/main/tools/README.md#bpmn--geração-e-renderização-dos-diagramas)) |
| Prefixo dos diagramas | `S` (`S0`, `S1`…) — não reutilizar `D` (já é do Bloco A) |
| Arquivo(s)-fonte | `docs/assets/bpmn/subequipe_01_bpmn-s0-*.bpmn` (convenção completa em `tools/README.md`) |
| Versão do modelo | _a definir_ |

### D.2. Elementos da Notação Utilizados

_a preencher — quais recursos do BPMN (eventos, gateways, raias, dados) este bloco usa e por quê, no mesmo espírito do [Bloco A §4](#_4-elementos-da-notação-utilizados)._

### D.3. Leitura do Modelo

_a preencher — narrativa do evento de início ao fim, gateway a gateway._

### D.4. Rastreabilidade & Elos com Outros Artefatos

_a preencher — todo elemento com origem em [Eng. Reversa, Bloco D](3.EngenhariaReversa.md#d5-achados)._

### D.5. Senso Crítico

_a preencher._

### D.6. Participantes & Comprobatórios
...
Consolidadas em [Referências](6.Referencias.md) — em especial R05 (OMG, BPMN 2.0), R13 (White & Miers), R10 (Chikofsky & Cross) e R08 (HLS).
...
| 1.1 | 23/08/2026 | Definição do fluxo modelado (Assistir Transmissão ao Vivo) e da ferramenta (Camunda), a partir da Ata 02 | [SubEquipe_01](../../../Projeto/Atas/Atas_Sg1/ata-S1-01-2026-08-23.md) | Lucas Andrade Zanetti |
| 1.2 | 27/08/2026 | Publicação do modelo v1: sete diagramas encadeados (D0 a D5), fundamentação da notação, inventário de 43 tipos de elemento com justificativa, leitura do modelo, rastreabilidade elemento a elemento e senso crítico | Lucas Andrade Zanetti | _(pendente)_ |
