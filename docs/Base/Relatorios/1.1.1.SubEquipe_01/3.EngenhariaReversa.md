...
| -- | -- | -- |
| Lucas Andrade Zanetti | Definição do recorte e do protocolo de coleta; execução das etapas 1–13; construção das ferramentas de coleta e anonimização; redação desta página | Registro da versão v1 no PR da branch |
| Heitor Macedo Ricardo | Coleta e análise das evidências; autoria dos diagramas D1 e D4; revisão da classificação de confiança | Registro da versão v1 no PR da branch |
| Matheus Lemes Amaral | Coleta e análise das evidências; autoria do diagrama D2; revisão da rastreabilidade | Registro da versão v1 no PR da branch |
| Pedro Druck Montalvão Reis | Coleta e análise das evidências; autoria do diagrama D2b; revisão do modelo | Registro da versão v1 no PR da branch |
