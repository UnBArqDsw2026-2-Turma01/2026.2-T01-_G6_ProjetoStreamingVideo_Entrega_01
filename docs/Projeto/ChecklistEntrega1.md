...
| -- | :--: | -- |
| Cada artefato e decisão embasados na literatura | ✅ (SubEquipe_01, SubEquipe_03) | **SubEquipe_01**: [6.Referências](Base/Relatorios/1.1.1.SubEquipe_01/6.Referencias) (16 referências ABNT — Checkland, Chung et al., OMG BPMN 2.0, Chikofsky & Cross, RFCs IETF de HLS/TLS/HTTP Caching, W3C Media Source Extensions — + 8 fontes complementares) · **SubEquipe_03**: [6.Referências](Base/Relatorios/1.1.3.SubEquipe_03/6.Referencias) (Checkland, Chung, Monk & Howard, RFCs IETF, OWASP, LGPD/ECA) |
| Atas de reunião bem elaboradas | ✅ (SubEquipe_01, SubEquipe_03) | **SubEquipe_01**: [Atas de Reunião](Projeto/Atas/README) · [Ata S1_03](Projeto/Atas/Atas_Sg1/ata-S1-03-2026-08-26) (11 pontos de discussão, decisões e encaminhamento explícito de revisão) · **SubEquipe_03**: [Atas de Reunião](Projeto/Atas/README) · [Ata Presencial S3_01](Projeto/Atas/Atas_Sg3/ata-S3-01-2026-08-25) |
| Vídeos/gravações das reuniões | ✅ | [Atas](Projeto/Atas/README) |
| Práticas metodológicas evidenciadas (reuniões periódicas, checklists, debates) | ✅ | [Metodologia](Projeto/Metodologia) · [Checklist Entrega 1](Projeto/ChecklistEntrega1) |
| Uso de **vários** recursos de modelagem do NFR Framework | ✅ (SubEquipe_01, SubEquipe_03) | **SubEquipe_01**: [SIG NFR Framework](Base/Relatorios/1.1.1.SubEquipe_01/2.NFRFramework) (4 ramos de softgoal — Desempenho, Segurança, Confiabilidade, Usabilidade —, decomposição AND, 23 operacionalizações, operadores MAKE/HELP/HURT/BREAK e 2 conflitos de trade-off formalizados) · **SubEquipe_03**: [SIG NFR Framework](Base/Relatorios/1.1.3.SubEquipe_03/2.NFRFramework) (NFR, Operationalizing, Claims, Decomposições AND/OR, Operadores MAKE/HELP/HURT/BREAK, Propagação bottom-up) |
| Uso de **vários** recursos da notação BPMN | ✅ (SubEquipe_01, SubEquipe_03) | **SubEquipe_01**: [BPMN](Base/Relatorios/1.1.1.SubEquipe_01/4.BPMN) (7 diagramas encadeados em 3 níveis, subprocessos de chamada, eventos de borda e gateways baseados em evento, pools distintas por participante autônomo) · **SubEquipe_03**: [BPMN](Base/Relatorios/1.1.3.SubEquipe_03/4.BPMN) (13 pools integradas, fluxos de mensagem/sequência, gateways exclusivos, eventos de início/fim e visualizador interativo) |
| Pontos de vista fundamentados, claros e com senso crítico | ✅ (SubEquipe_01, SubEquipe_03) | **SubEquipe_01**: [Senso Crítico Rich Picture](Base/Relatorios/1.1.1.SubEquipe_01/1.ArtefatoGeneralista) · [Senso Crítico NFR](Base/Relatorios/1.1.1.SubEquipe_01/2.NFRFramework.md#_7-senso-crítico) · [Senso Crítico Eng. Reversa](Base/Relatorios/1.1.1.SubEquipe_01/3.EngenhariaReversa.md#_8-senso-crítico) · [Senso Crítico BPMN](Base/Relatorios/1.1.1.SubEquipe_01/4.BPMN.md#_7-senso-crítico) · [Pontos de Vista IA](Base/Relatorios/1.1.1.SubEquipe_01/5.IAGenerativa.md#_3-pontos-de-vista-individuais) · **SubEquipe_03**: [Senso Crítico Rich Picture](Base/Relatorios/1.1.3.SubEquipe_03/1.ArtefatoGeneralista.md#6-senso-crítico) · [Senso Crítico NFR](Base/Relatorios/1.1.3.SubEquipe_03/2.NFRFramework.md#7-senso-crítico) · [Senso Crítico BPMN](Base/Relatorios/1.1.3.SubEquipe_03/4.BPMN.md#7-senso-crítico) · [Pontos de Vista IA](Base/Relatorios/1.1.3.SubEquipe_03/5.IAGenerativa.md#3-pontos-de-vista-individuais) |

## 5. Apresentação (~15min: 5min por foco)

| Item | Status | Responsável |
| -- | -- | -- |
| Roteiro da apresentação dividido por foco | ⬜ | |
| Quadro de participações & commits pronto para exibir | ⬜ | |
| Justificativas & senso crítico sobre o trabalho realizado | ⬜ | |
| Comentários gerais sobre o trabalho em equipe | ⬜ | |
| Conteúdo baixado com antecedência (contingência de internet) | ⬜ | |
| Máquina própria confirmada para o dia | ⬜ | |
...
| 1.4 | 28/08/2026 | §4 (Menções Superiores) passa a creditar a SubEquipe_01 em todos os cinco critérios, com evidência específica (referências ABNT, ata S1_03, SIG em 4 ramos, BPMN em 7 diagramas e senso crítico consolidado) ao lado da SubEquipe_03 | Lucas Andrade Zanetti | - |
