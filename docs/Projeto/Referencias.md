...
>
> A diretriz proíbe **usar o nome real da fonte de inspiração para nomear ou descrever o projeto** — por isso o projeto se chama `G7_ProjetoStreamingVideo` e todos os artefatos referem-se à plataforma por suas características.
>
...
| # | Referência (ABNT) | Status | Uso previsto |
| -- | -- | -- | -- |
| R06 | BECK, Kent *et al.* **Manifesto para o desenvolvimento ágil de software**. 2001. Disponível em: https://agilemanifesto.org/iso/ptbr/manifesto.html. Acesso em: 22 ago. 2026. | 🔜 | Embasar a escolha por uma abordagem ágil adaptada, em vez de processo prescritivo |
| R07 | SCHWABER, Ken; SUTHERLAND, Jeff. **O Guia do Scrum**: o guia definitivo para o Scrum — as regras do jogo. [S. l.: s. n.], 2020. Disponível em: https://scrumguides.org/. Acesso em: 22 ago. 2026. | 🔜 | Origem dos rituais adotados (abertura, revisão) e delimitação do que **não** foi adotado |
| R08 | BROOKS JR., Frederick P. **The Mythical Man-Month**: essays on software engineering. Anniversary ed. Boston: Addison-Wesley, 1995. | 🔜 | Justificar a divisão em subequipes autônomas pelo custo de comunicação em equipes grandes |
| R09 | KNAPP, Jake; ZERATSKY, John; KOWITZ, Braden. **Sprint**: how to solve big problems and test new ideas in just five days. New York: Simon & Schuster, 2016. | 🔜 | Fundamentar por que o *Design Sprint*, sugerido nas diretrizes, não se aplica ao recorte desta entrega |

## 3. Fontes por Artefato

> Referências específicas de cada artefato (NFR Framework, BPMN, Engenharia Reversa, Rich Picture, Mapa Mental) ficam na página **`6.Referencias.md`** de cada subequipe, junto do artefato que embasam. Esta página consolida apenas o que é comum ao projeto.

| Artefato | Onde ficam as referências |
| -- | -- |
| SubEquipe_01 | [1.1.1 · Referências](../Base/Relatorios/1.1.1.SubEquipe_01/6.Referencias.md) |
| SubEquipe_02 | [1.1.2 · Referências](../Base/Relatorios/1.1.2.SubEquipe_02/6.Referencias.md) |
| SubEquipe_03 | [1.1.3 · Referências](../Base/Relatorios/1.1.3.SubEquipe_03/6.Referencias.md) |
